            ...
            <div class="col-lg-12">
                <div class="card" style="margin-right: -15px; margin-left: -15px">
                    ...
                    <div class="card-header d-flex align-items-center">
                        <h3 class="h4">
                            服务<c:if test="${requestScope.get('obj').id != null}">修改</c:if><c:if
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" id="formId" AUTOCOMPLETE="OFF" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="price" class="form-control" required
                                           placeholder="请输入价格" value="${requestScope.get("obj").price}"
                                           data-msg="请输入价格">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3 form-control-label">详情</label>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 form-control-label">评论数</label>
                                <div class="col-sm-9">
                                    <input type="text" name="commentsReadCount" class="form-control"
                                           placeholder="请输入评论数" value="${requestScope.get("obj").commentsReadCount}"
                                           data-msg="请输入评论数">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3 form-control-label">订单数</label>
                                <div class="col-sm-9">
                                    <input type="text" name="ordersCount" class="form-control"
                                           placeholder="请输入订单数" value="${requestScope.get("obj").ordersCount}"
                                           data-msg="请输入订单数">
                                </div>
                            </div>
...
<script type="text/javascript">
    function sub() {
        ...
        if (flag) {
            getJsp("/pro/admin/add", 'post', $("#formId").serialize());
        }
    }
