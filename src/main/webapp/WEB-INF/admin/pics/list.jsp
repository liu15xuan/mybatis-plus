                        ...
                        <div class="card-close">
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="closeCard1" class="dropdown-menu dropdown-menu-right has-shadow">
                                    <a onclick="getJsp('/pics/admin/add', 'get', '')" href="#" class="dropdown-item"> <i class="fa fa-address-card"></i>新增展示图</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4">展示图列表</h3>
                        </div>
                        <div class="card-body">
...
<td>${item.createdTime.toString().replace("T", " ")}</td>
                                            ...
                                            <td>
                                                <button onclick="showDeleteModal('/pics/admin/del', ${item.id})"  class="btn btn-sm btn-danger">删除</button>
                                                <button onclick="getJsp('/pics/admin/add', 'get', 'id=${item.id}')"  class="btn btn-sm btn-info">修改</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                            ...
                            <c:if test="${requestScope.get('page').getCurrent() == 1}">
                               disabled
                                ...
                                ">
                                    <a class="page-link"
                                       onclick="getJsp('/pics/admin/list', 'get', 'current=1&size=5')"
                                       href="##">首页</a></li>
                                <li class="page-item
                             <c:if test="${requestScope.get('page').getCurrent() == 1}">
                               disabled
                            ...
                            "><a class="page-link"
                                 onclick="getJsp('/pics/admin/list', 'get', 'current=${requestScope.get('page').getCurrent()-1}&size=5')"
                                 href="##">上一页</a></li>
                                <li class="page-item
                            ...
                            "><a class="page-link"
                                 onclick="getJsp('/pics/admin/list', 'get', 'current=${requestScope.get('page').getPages()}&size=5')"
                                 href="##">尾页</a>
                                </li>
