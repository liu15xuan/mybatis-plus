            ...
            <div class="welcome-content-box">
                <div class="row">
                    ...
                    <div class="col-md-6 welcom-box col-md-offset-3">
                        <form id="formId" action="/login" autocomplete="off" method="post"
                              onsubmit="return register();">
                            <input value="0" name="role" hidden>
                            <div class="form-group">
                                <input class="form-control" name="username" required data-toggle="12312"
                                       placeholder="账号"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div style="float: right">
                                <p>还没有有账号，去<span style="cursor: pointer; color: #2b90d9" onclick="toLogin()">注册</span></p>
                            </div>
                        </form>
                    </div>
                </div>
